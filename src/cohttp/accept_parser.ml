...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 43 "src/accept_parser.mly"
                    ( Kv (_2, S _4) )
# 127 "src/accept_parser.ml"
               : 'param))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 2 : string) in
    let _4 = (Parsing.peek_val __caml_parser_env 0 : string) in
    Obj.repr(
# 44 "src/accept_parser.mly"
                     (
  if _2="q" then try Q (truncate (1000.*.(float_of_string _4)))
    with Failure _ -> raise Parsing.Parse_error
  else Kv (_2, T _4)
)
# 139 "src/accept_parser.ml"
               : 'param))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'param) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'params) in
    Obj.repr(
# 51 "src/accept_parser.mly"
               ( _1::_2 )
# 147 "src/accept_parser.ml"
               : 'params))
; (fun __caml_parser_env ->
    Obj.repr(
# 52 "src/accept_parser.mly"
  ( [] )
# 153 "src/accept_parser.ml"
               : 'params))
; (fun __caml_parser_env ->
    let _4 = (Parsing.peek_val __caml_parser_env 0 : 'params) in
    Obj.repr(
# 55 "src/accept_parser.mly"
                         (
  (get_q _4, (AnyMedia, get_rest _4))
)
# 162 "src/accept_parser.ml"
               : 'media_range))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 3 : string) in
    let _4 = (Parsing.peek_val __caml_parser_env 0 : 'params) in
    Obj.repr(
# 58 "src/accept_parser.mly"
                        (
  (get_q _4, (AnyMediaSubtype (String.lowercase _1), get_rest _4))
)
# 172 "src/accept_parser.ml"
               : 'media_range))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 3 : string) in
    ...
    let _4 = (Parsing.peek_val __caml_parser_env 0 : 'params) in
    Obj.repr(
# 61 "src/accept_parser.mly"
                       (
  (get_q _4, (MediaType (String.lowercase _1, String.lowercase _3), get_rest _4))
)
# 183 "src/accept_parser.ml"
               : 'media_range))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'media_range) in
    Obj.repr(
# 66 "src/accept_parser.mly"
                  ( [_1] )
# 190 "src/accept_parser.ml"
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 67 "src/accept_parser.mly"
                                 ( _1::_3 )
# 198 "src/accept_parser.ml"
               : (Accept_types.media_range * Accept_types.p list) Accept_types.qlist))
; (fun __caml_parser_env ->
    Obj.repr(
# 68 "src/accept_parser.mly"
      ( [] )
# 204 "src/accept_parser.ml"
               : (Accept_types.media_range * Accept_types.p list) Accept_types.qlist))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : string) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'params) in
    Obj.repr(
# 71 "src/accept_parser.mly"
             ( (get_q _2, Charset (String.lowercase _1)) )
# 212 "src/accept_parser.ml"
               : 'charset))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'params) in
    Obj.repr(
# 72 "src/accept_parser.mly"
              ( (get_q _2, AnyCharset) )
# 219 "src/accept_parser.ml"
               : 'charset))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'charset) in
    Obj.repr(
# 75 "src/accept_parser.mly"
              ( [_1] )
# 226 "src/accept_parser.ml"
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 76 "src/accept_parser.mly"
                         ( _1::_3 )
# 234 "src/accept_parser.ml"
               : Accept_types.charset Accept_types.qlist))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : string) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'params) in
    Obj.repr(
# 79 "src/accept_parser.mly"
             (
  (get_q _2, match (String.lowercase _1) with
    | "gzip" -> Gzip
    | "compress" -> Compress
    | "deflate" -> Deflate
    | "identity" -> Identity
...
# 250 "src/accept_parser.ml"
               : 'encoding))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'params) in
    Obj.repr(
# 88 "src/accept_parser.mly"
              ( (get_q _2, AnyEncoding) )
# 257 "src/accept_parser.ml"
               : 'encoding))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'encoding) in
    Obj.repr(
# 91 "src/accept_parser.mly"
               ( [_1] )
# 264 "src/accept_parser.ml"
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 92 "src/accept_parser.mly"
                           ( _1::_3 )
# 272 "src/accept_parser.ml"
               : Accept_types.encoding Accept_types.qlist))
; (fun __caml_parser_env ->
    Obj.repr(
# 93 "src/accept_parser.mly"
      ( [] )
# 278 "src/accept_parser.ml"
               : Accept_types.encoding Accept_types.qlist))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : string) in
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'params) in
    Obj.repr(
# 96 "src/accept_parser.mly"
             (
  (get_q _2, Language (Stringext.split ~on:'-' (String.lowercase _1)))
)
# 288 "src/accept_parser.ml"
               : 'language))
; (fun __caml_parser_env ->
    let _2 = (Parsing.peek_val __caml_parser_env 0 : 'params) in
    Obj.repr(
# 99 "src/accept_parser.mly"
              ( (get_q _2, AnyLanguage) )
# 295 "src/accept_parser.ml"
               : 'language))
; (fun __caml_parser_env ->
    let _1 = (Parsing.peek_val __caml_parser_env 1 : 'language) in
    Obj.repr(
# 102 "src/accept_parser.mly"
               ( [_1] )
# 302 "src/accept_parser.ml"
...
; (fun __caml_parser_env ->
    ...
    Obj.repr(
# 103 "src/accept_parser.mly"
                           ( _1::_3 )
# 310 "src/accept_parser.ml"
               : Accept_types.language Accept_types.qlist))
(* Entry media_ranges *)
